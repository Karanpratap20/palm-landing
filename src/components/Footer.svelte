<script>
    ...
    const socials = [
        ...
        // Added LinkedIn
        { icon: "linkedin", link: "https://www.linkedin.com/in/VikalpHospitality" },
        // Added YouTube
        { icon: "youtube", link: "https://www.youtube.com/@VikalpHospitality" },
        // Added X (formerly Twitter)
        { icon: "x-twitter", link: "https://x.com/vikalphotels" }
    ];
                    ...
                    {#each socials as social}
                        <a href={social.link} target="_blank" rel="noopener"
                            ...
                            {:else if social.icon === "youtube"}
                                <i class="fa-brands fa-youtube text-blue-700 text-xl"></i>
                            {:else if social.icon === "x-twitter"}
                                <i class="fa-brands fa-x-twitter text-blue-700 text-xl"></i>
                            {/if}
                        </a>
                    {/each}
                </div>
